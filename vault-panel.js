      ...
      panel.innerHTML = `
        <style>
          #__cv-panel {
            ...
            animation: __cv-slide 0.2s ease;
        ...
        <iframe id="__cv-frame" src="" style="display:none" onload="this.style.display='block'"></iframe>
      `;
      document.body.appendChild(panel);

      // Set iframe src after panel is in DOM
      setTimeout(() => {
        const iframe = document.getElementById("__cv-frame");
        if (iframe) {
